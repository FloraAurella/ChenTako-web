...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  18399 pixels (ratio 0.02 of all image pixels) are different.
        ...
        - region [ref=e94]:
          ...
          - region [ref=e110]:
            ...
            - generic [ref=e113]:
              - generic [ref=e114]:
                - generic [ref=e115]:
                  - generic [ref=e116]: 输入预算（Tokens）
                  - button "继承聊天 · 自定义" [ref=e117] [cursor=pointer]
                - spinbutton "输入预算（Tokens）" [disabled] [ref=e118]
                - paragraph [ref=e119]: 留空 = 模型窗口 − 最大输出 − 5% 安全余量。
              - generic [ref=e120]:
                - generic [ref=e121]:
                  - generic [ref=e122]: 自动压缩历史
                  - button "继承聊天 · 自定义" [ref=e123] [cursor=pointer]
                - switch "自动压缩历史" [disabled] [ref=e124]
                - paragraph [ref=e125]: 达阈值后额外请求模型压缩历史，保留聊天记录。
              - generic [ref=e126]:
                - generic [ref=e127]:
                  - generic [ref=e128]: 压缩触发阈值（%）
                  - button "继承聊天 · 自定义" [ref=e129] [cursor=pointer]
                - spinbutton "压缩触发阈值（%）" [disabled] [ref=e130]: "80"
                - paragraph [ref=e131]: 达到输入预算的此比例时压缩。
            - paragraph [ref=e132]: model-a 的可用输入预算：116,326 Tokens（估算）。 按当前模型发送，用量为估算。
        - region [ref=e133]:

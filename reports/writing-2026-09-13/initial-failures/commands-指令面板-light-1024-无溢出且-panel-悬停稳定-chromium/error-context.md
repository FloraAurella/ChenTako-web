...
- Name: commands.spec.js >> 指令面板 light 1024 无溢出且 panel 悬停稳定
...
- generic [ref=e1]:
  - generic [ref=e4]:
    - navigation "快捷导航" [ref=e5]:
      - button "展开侧栏" [ref=e6] [cursor=pointer]
      - button "新建对话" [ref=e16] [cursor=pointer]
      - button "搜索对话" [ref=e19] [cursor=pointer]
      - button "导入对话" [ref=e23] [cursor=pointer]
      - button "设置" [ref=e26] [cursor=pointer]
    - main [ref=e30]:
      - generic [ref=e31]:
        - generic [ref=e33]:
          - generic [ref=e34]: Chat · 对话
          - generic [ref=e35]: 新对话
        - generic "本地服务正常" [ref=e38]
      - region "对话" [ref=e42]:
        - heading "欢迎回来，随时开始吧" [level=2] [ref=e52]
        - generic [ref=e54]:
          - button "当前项目：无项目" [ref=e56] [cursor=pointer]:
            - generic [ref=e60]: 无项目
          - generic [ref=e64]:
            - textbox "输入消息，/ 打开指令" [active] [ref=e66]: /
            - generic [ref=e67]:
              - button "添加附件" [ref=e68] [cursor=pointer]
              - generic [ref=e71]:
                - button "model-a 中等" [ref=e72] [cursor=pointer]:
                  - generic [ref=e73]: model-a
                  - generic [ref=e74]: 中等
                - button "压缩上下文（已用约 0%）" [ref=e78] [cursor=pointer]
                - button "发送" [ref=e83] [cursor=pointer]
          - generic [ref=e86]: Enter 发送 · Shift + Enter 换行
  - generic "指令" [ref=e88]:
    - listbox "指令" [ref=e89]:
      - option "模型 切换当前会话模型 · model-a" [selected] [ref=e90] [cursor=pointer]:
        - generic [ref=e97]:
          - generic "/model" [ref=e98]: 模型
          - generic [ref=e99]: 切换当前会话模型 · model-a
      - option "思考强度 调整思考强度或恢复跟随配置 · medium · 跟随配置" [ref=e100] [cursor=pointer]:
        - generic [ref=e105]:
          - generic "/effort" [ref=e106]: 思考强度
          - generic [ref=e107]: 调整思考强度或恢复跟随配置 · medium · 跟随配置
      - option "压缩历史 没有可压缩的已完成历史。" [disabled] [ref=e108] [cursor=pointer]:
        - generic [ref=e113]:
          - generic "/compact" [ref=e114]: 压缩历史
          - generic [ref=e115]: 没有可压缩的已完成历史。
      - option "创建章节 创建并选中空章节" [ref=e116] [cursor=pointer]:
        - generic [ref=e120]:
          - generic "/create" [ref=e121]: 创建章节
          - generic [ref=e122]: 创建并选中空章节
      - option "讨论 切换讨论模式，可附带要求" [ref=e123] [cursor=pointer]:
        - generic [ref=e127]:
          - generic "/chat" [ref=e128]: 讨论
          - generic [ref=e129]: 切换讨论模式，可附带要求
      - option "写作 切换写作模式，可附带要求" [ref=e130] [cursor=pointer]:
        - generic [ref=e134]:
          - generic "/write" [ref=e135]: 写作
          - generic [ref=e136]: 切换写作模式，可附带要求
      - option "编辑 切换编辑模式，可附带要求" [ref=e137] [cursor=pointer]:
        - generic [ref=e141]:
          - generic "/edit" [ref=e142]: 编辑
          - generic [ref=e143]: 切换编辑模式，可附带要求
      - option "帮助 查看指令帮助" [ref=e144] [cursor=pointer]:
        - generic [ref=e148]:
          - generic "/help" [ref=e149]: 帮助
          - generic [ref=e150]: 查看指令帮助
```

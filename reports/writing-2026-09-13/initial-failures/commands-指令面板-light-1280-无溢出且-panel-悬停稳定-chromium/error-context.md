...
- Name: commands.spec.js >> 指令面板 light 1280 无溢出且 panel 悬停稳定
    ...
    - complementary "对话" [ref=e5]:
      ...
      - generic [ref=e34]:
        ...
        - region "聊天" [ref=e47]:
          ...
          - generic [ref=e53]:
            - button "另一个会话 今天" [ref=e54] [cursor=pointer]:
              - generic [ref=e55]: 另一个会话
              - generic [ref=e57]: 今天
            - button "未命名对话 今天" [ref=e59] [cursor=pointer]:
              - generic [ref=e60]: 未命名对话
              - generic [ref=e62]: 今天

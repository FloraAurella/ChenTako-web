...
- Name: visual.spec.js >> Everforest 运行配置与模型选择器
- Location: e2e/visual.spec.js:337:1
...
Call log:
  - Expect "toHaveScreenshot(everforest-runtime-root.png)" with timeout 5000ms
    - verifying given screenshot expectation
  - waiting for locator('.runtime-root-popover')
    - locator resolved to <div class="popover-card runtime-popover runtime-root-popover">…</div>
...
- generic [ref=e2]:
        ...
        - generic [ref=e85]:
          ...
          - generic [ref=e95]:
            ...
            - generic [ref=e98]:
              ...
              - generic [ref=e102]:
                - button "demo-model 中等" [expanded] [active] [ref=e103] [cursor=pointer]:
  ...
  - generic [ref=e119]:
    - button "模型 demo-model" [ref=e120] [cursor=pointer]:
      - generic [ref=e121]: 模型
      - generic "demo-model" [ref=e122]
    - button "思考强度 中等" [ref=e126] [cursor=pointer]:
      - generic [ref=e127]: 思考强度
      - generic [ref=e128]: 中等
```

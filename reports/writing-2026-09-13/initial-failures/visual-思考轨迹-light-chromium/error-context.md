...
- Name: visual.spec.js >> 思考轨迹 light
- Location: e2e/visual.spec.js:294:3
...
Call log:
  - Expect "toHaveScreenshot(reasoning-trail-light.png)" with timeout 5000ms
    ...
    - region "对话" [ref=e77]:
      - generic [ref=e79]:
        ...
        - generic [ref=e103]:
          ...
          - generic [ref=e111]:
            - button "已思考 （用时 2s）" [expanded] [ref=e112] [cursor=pointer]:
              - generic [ref=e117]: 已思考
              - generic [ref=e118]: （用时 2s）
            - generic [ref=e124]:
              - paragraph [ref=e125]: 先确认用户真正需要的是回答结构，而不是直接扩展正文；接着核对已有上下文、限制条件和期望语气，避免遗漏会影响结论的细节，并把可以验证的事实与尚待确认的判断明确区分。
              - paragraph [ref=e126]: 再按结论、依据和下一步三个层次组织内容，让长段思考充分使用与正式回答相同的消息列宽，同时保持语言简洁、层级清楚，并确保用户能够快速定位真正需要执行的部分。
          - paragraph [ref=e130]: 我会先给出结论，再说明判断依据，最后整理成可以直接执行的下一步。
          - generic [ref=e131]: 09:59 · 3s
          - generic [ref=e132]:
            - button "复制" [ref=e133] [cursor=pointer]
            - button "编辑" [ref=e137] [cursor=pointer]
            - button "复制到新对话" [ref=e141] [cursor=pointer]
            - button "重新生成" [ref=e147] [cursor=pointer]
            - button "删除消息" [ref=e150] [cursor=pointer]
      - generic [ref=e154]:
        - generic [ref=e155]:
          - textbox "输入消息，/ 打开指令" [ref=e157]
          - generic [ref=e158]:
            - button "添加附件" [ref=e159] [cursor=pointer]
            - generic [ref=e162]:
              - button "demo-model 中等" [ref=e163] [cursor=pointer]:
                - generic [ref=e164]: demo-model
                - generic [ref=e165]: 中等
              - button "压缩上下文（已用约 0%）" [ref=e169] [cursor=pointer]
              - button "发送" [disabled] [ref=e174]
        - generic [ref=e177]: Enter 发送 · Shift + Enter 换行
```
